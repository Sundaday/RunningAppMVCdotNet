...
namespace RunningApp.Controllers
{
    public class ClubController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Edit(int id) //Return Clubdata by id
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(int id, EditClubViewModel clubVM) //Make edition after getData
        {
